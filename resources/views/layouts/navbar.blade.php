        ...
        <ul class="space-y-2 font-medium">
            <li>
                <a href="{{ route('dashboard') }}" class="flex items-center p-2 text-black rounded-lg hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'dashboard') ? 'bg-red-600' : '' }}" id="navLink">
                    <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-5 h-5 text-black transition duration-75 group-hover:text-white {{ request()->routeIs('dashboard') ? 'text-white' : '' }}" id="navIcon" viewBox="0 0 15 15">
            ...
            <li>
                <a href="{{ route('doctor') }}" class="flex items-center p-2 text-black rounded-lg hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'doctor') ? 'bg-red-600' : '' }}" id="navLink">
                    <svg class="flex-shrink-0 w-5 h-5 text-black font-bold transition duration-75 group-hover:text-white {{ request()->routeIs('doctor') ? 'text-white' : '' }}" viewBox="0 0 27 27" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a href="{{ route('patient') }}" class="flex items-center p-2 text-black rounded-lg hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'patient') ? 'bg-red-600' : '' }}" id="navLink">
                    <svg class="flex-shrink-0 w-5 h-5 text-black transition duration-75 group-hover:text-white {{ request()->routeIs('patient') ? 'text-white' : '' }}" viewBox="0 0 27 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <li>
                <a href="{{ route('assessment') }}" class="flex items-center p-2 text-black rounded-lg hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'assessment') ? 'bg-red-600' : '' }}" id="navLink">
                    <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-5 h-5 text-black transition duration-75 group-hover:text-white {{ request()->routeIs('assessment') ? 'text-white' : '' }}" id="navIcon" viewBox="0 0 16 16">
            ...
            <li>
                <a href="{{ route('question') }}" class="flex items-center p-2 text-black rounded-lg hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'question') ? 'bg-red-600' : '' }}" id="navLink">
                    <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-5 h-5 text-black transition duration-75 group-hover:text-white {{ request()->routeIs('question') ? 'text-white' : '' }}" viewBox="0 0 32 32">
            ...
            <li>
                <a href="{{ route('profile') }}" class="flex items-center p-2 text-black rounded-lg hover:bg-red-600 group {{ Str::contains(Route::currentRouteName(), 'profile') ? 'bg-red-600' : '' }}" id="navLink">
                    <svg xmlns="http://www.w3.org/2000/svg" class="flex-shrink-0 w-5 h-5 text-black font-bold transition duration-75 group-hover:text-white {{ request()->routeIs('profile') ? 'text-white' : '' }}" id="navIcon" viewBox="0 0 16 16">
                        <g fill="none">
