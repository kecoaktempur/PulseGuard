                    ...
                    <div class="text-start w-full">
                        <div class="flex items-center justify-between mb-5">
                            ...
                            <div class="flex space-x-2">
                                <a href="{{ route('profile') }}" class="text-sm bg-transparent hover:bg-indigo-400 text-indigo-400 font-semibold hover:text-white py-1 px-2 border border-indigo-400  hover:border-transparent rounded">
                                    Cancel
                                </a>
                        ...
                        <div class="flex mb-4">
                            ...
                            <div class="w-1/2 pl-2 mb-6">
                                <div class="relative z-0 border-b border-gray-700">
                                    ...
                                    <label for="lastname" class="absolute font-semibold duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6 rtl:peer-focus:translate-x-1/4 rtl:peer-focus:left-auto" style="color: #5A7DFA;">Last Name</label>
                        ...
                        <div class="flex mb-4">
                            ...
                            <div class="w-1/3 pl-2 pr-2 mb-6">
                                <div class="relative w-32" id="dropdownButton">
                                    <div class="text-xs font-medium text-black mb-1" style="color: #5A7DFA;">Gender
                                    </div>
                                    <select id="gender" name="gender" autocomplete="gender" required class="border-solid border-indigo-400 border-[1px] px-3 py-1 rounded-lg cursor-pointer font-bold flex justify-between items-center bg-white">
